...
export function SigninForm({
    ...
    // 3. The submit handler receives the form data automatically
    const onSubmit = async (data) => {
        console.log("Form data captured on client:", data);
        setApiError('');
        try {
                ...
                <div className="flex flex-col gap-6">
                    <div className="flex flex-col items-center gap-2">
                        <a href="#" className="flex flex-col items-center gap-2 font-medium">
                            ...
                            <span className="sr-only">Code Manager</span>
                        </a>
                        <h1 className="text-xl font-bold">Welcome to Code Manager</h1>
